...
# Setting threshold value if greater than 0.72 means multicollinearity between independent features is high and we have to remove that features:
correlation(dataset, 0.72)
...
filename = 'Breast.pkl'
pickle.dump(lr, open(filename, 'rb'))